...
# Idea:
#
# For tickers that meet the criteria
# if earnings is in the morning on day N, make "calendar" purchase (with 30 day spread) 15 minutes before market close on day N-1 *as close to the stock price as possible*.
# if earnings is after-market-close on day N, make "calendar" purchase (with 30 day spread) 15 minutes before market close on day N *as close to the stock price as possible*
# exit the "calendar" options trade 15 minutes after market open, the day after earnings are announced

# CONFIRM THAT THE STRIKE PRICE SHOULD BE AS CLOSE TO THE STOCK PRICE AS POSSIBLE.
